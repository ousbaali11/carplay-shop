  ...
  return (
    <Link href={href} className="brand">
      {logoUrl ? (
        ...
        <svg className="brand-logo" width={logoHeight} height={logoHeight} viewBox="0 0 30 30" fill="none">
          <rect x="1" y="1" width="28" height="28" rx="7" stroke="currentColor" strokeWidth="2" />
          <path d="M9 19V13.5C9 12.1 10.1 11 11.5 11H18.5C19.9 11 21 12.1 21 13.5V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      ...
      <span className="brand-name">
        ...
        {second && <span className="brand-second">{second}</span>}
      </span>
    </Link>
  );
}
